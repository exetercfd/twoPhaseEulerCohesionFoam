...
{
    defineTypeNameAndDebug(Makkawi, 0);
...
Foam::tmp<Foam::volScalarField>
Foam::kineticTheoryModels::cohesionModels::Makkawi::nu
(
    const phaseModel& phase,
...
) const
{
    ...
    return dimensionedScalar("1.0", dimTime, 1.0)*pf*constant::mathematical::pi/(6.0*(1.0-alpha) + SMALL);
}


bool Foam::kineticTheoryModels::cohesionModels::Makkawi::read()
{
